...
from groq import Groq  # Importing the Groq library to use a chatbot
...
from dotenv import dotenv_values  # Importing dotenv_values to load environment variables
