...
def QueryModifier(Query):
    ...
    query_words = ["how", "what", "who", "where", "when", "why", "which", "whose", "whom", "can you", "what's", "where's", "hpw's"]
...
class InitialScreen(QWidget):
    def __init__(self, parent=None):
        ...
        content_layout.setContentsMargins(0, 0, 150, 150)
        self.setLayout(content_layout)
